...
var notie = function(){
    ...
    if (window.innerWidth <= options.font_change_screen_width) { confirm_text.style.fontSize = options.font_size_small; }
    ...
    if (window.innerWidth <= options.font_change_screen_width) { confirm_yes_text.style.fontSize = options.font_size_small; }
    ...
    if (window.innerWidth <= options.font_change_screen_width) { confirm_no_text.style.fontSize = options.font_size_small; }

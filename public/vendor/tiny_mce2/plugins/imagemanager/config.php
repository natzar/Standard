...
*/
	...
	$mcImageManagerConfig['upload.max_width'] = "556"; // Only if force_width_height is true
	$mcImageManagerConfig['upload.max_height'] = "9000"; // Only if force_width_height is true

function replaceAll( text, busca, reemplaza, func ){
...
jQuery.fn.dataTableExt.aTypes.unshift(
	function ( sData )
	{
		...
		if (/^\d{1,2}\-\d{1,2}\-\d{2,4}$/.test(sData))
			return 'date-uk';
		else if (/^[0-9.]*$/.test(sData))
...
/*
jQuery.extend( jQuery.fn.dataTableExt.oSort, {
    "normal-pre": function ( a ) {
		return a.toLowerCase();
    },
 
    "normal-asc": function ( a, b ) {
        var retVal;
    	x = $.trim(x);
    	y = $.trim(y);
